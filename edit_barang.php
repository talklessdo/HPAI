            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="proses_ubah_barang.php" method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $edit['kode_barang'] ?>" name="kode_barang" class="form-control" id="kode" placeholder="Kode Barang">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="nama_barang" class="col-sm-3 col-form-label">Nama Barang</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $edit['nama_barang'] ?>" name="nama_barang" class="form-control" id="nama_barang" placeholder="Nama Barang">
                      </div>
                  </div>
