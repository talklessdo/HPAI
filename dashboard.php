...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <center class="p-3"><h2>SILAHKAN PILIH MENU</h2></center>
                  <div class="d-flex flex-column justify-content-center align-items-center" style="gap: 20px;">
                    <a href="barang.php">
                      <button type="button" class="btn btn-outline-primary btn-fw">
                        <span style="font-size: 2em;">BARANG</span>
                      </button>
                    </a>
                    <a href="transaksi.php">
                      <button type="button" class="btn btn-outline-warning btn-fw">
                        <span style="font-size: 2em;">TRANSAKSI</span>
                      </button>
                    </a>
                  </div>
                </div>
  ...
  <script>
    function myFunction() {
      ...
      if (r == true) {
        document.location.href = "hapus_barang.php?id=<?php echo $data['id']?>";
      } else {
        return;
      }
    }
