            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="proses_tambah_transaksi.php" method="POST">
                    <div class="form-group row">
                      <label for="kode" class="col-sm-3 col-form-label">Kode Transaksi</label>
                      <div class="col-sm-9">
                        <input type="text" name="kode_transaksi" class="form-control" id="kode" placeholder="Kode Transaksi" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="time" name="waktu_transaksi" class="form-control" id="waktu_transaksi" required>
                      </div>
                    </div>
                    <div class="d-flex justify-content-center">
                      <button type="submit" name="simpan" class="btn btn-primary mr-2">Simpan</button>
                      <button onclick="kembali()" class="btn btn-light">Batal</button>
                    </div>
                  </form>
                </div>
              </div>
